...
class ProductController {
    var products: [Product] = [Product(title: "Cottage Ornament", description: "Give your client a charming wooden cottage to commemorate the purchase of their home.", price: 29.95, fiveUnitPrice: 26.9, tenUnitPrice: 25.75, twentyUnitPrice: 24.85, image: "Cottage Ornament", category: .Ornament, count: 0),
                               ...
                               Product(title: "Slate Cheese Board", description: "Our charcoal slate products offer a beautifully rustic, organic surface to match any type of household. From a farmhouse styled home to a bachelor pad, these slate products are sure to make a statement. ", price: 59.55, fiveUnitPrice: 52.45, tenUnitPrice: 49.95, twentyUnitPrice: 47.30, image: "Slate Cheese Board", category: .CheeseBoard, count: 0, templates: [
                                        Template(image: "Slate3LTR", needs: [.initials, .date], fulfilled: []),
                                        Template(image: "SlateAntler", needs: [.initials, .date], fulfilled: []),
                                        Template(image: "SlateBold", needs: [.firstName, .firstName, .lastName, .lastInitial, .date], fulfilled: []),
                                        Template(image: "SlateChampagne", needs: [.firstName, .firstName, .lastName, .date], fulfilled: []),
                                        Template(image: "SlateElegant", needs: [.firstName, .firstName, .lastName, .date], fulfilled: []),
                                        Template(image: "SlateF&F", needs: [.address, .date], fulfilled: []),
                                        Template(image: "SlateHome", needs: [.state, .firstName, .firstName, .date], fulfilled: []),
                                        Template(image: "SlateHSH", needs: [.firstName, .firstName, .date], fulfilled: []),
                                        Template(image: "SlateImpact", needs: [.firstName, .firstName, .lastName, .date], fulfilled: []),
                                        Template(image: "SlateKey", needs: [.firstName, .firstName, .date], fulfilled: []),
                                        Template(image: "SlateLeaf", needs: [.firstName, .firstName, .lastName], fulfilled: []),
                                        Template(image: "SlateRustic", needs: [.date, .lastName], fulfilled: []),
                                        Template(image: "SlateScript", needs: [.initials, .date], fulfilled: []),
                                        Template(image: "SlateVisionary", needs: [.lastName, .date], fulfilled: []),
                                        Template(image: "SlateWhimsical", needs: [.firstName, .firstName, .lastName, .date], fulfilled: [])]),
